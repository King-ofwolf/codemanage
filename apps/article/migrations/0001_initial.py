    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(2019, 4, 11, 1, 12, 6, 321766, tzinfo=utc))),
                ...
                ('reviewers', models.ManyToManyField(related_name='review_articles', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'wr_article',
                'ordering': ('-created',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=16)),
                ('created', models.DateTimeField(default=datetime.datetime(2019, 4, 11, 1, 12, 6, 322764, tzinfo=utc))),
                ('updated', models.DateTimeField(auto_now=True)),
